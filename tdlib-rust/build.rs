...
use std::path::Path;
use tdlib_rust_gen::generate_rust_code;
use tdlib_rust_parser::parse_tl_file;
use tdlib_rust_parser::tl::Definition;

#[allow(dead_code)]
#[cfg(not(any(feature = "docs", feature = "pkg-config")))]
/// The version of the TDLib library.
const TDLIB_VERSION: &str = "1.8.42";
...
fn download_tdlib() {
    let base_url = "https://github.com/ankddev/tdlib-rust/releases/download";
    let url = format!(
        "{}/v{}/tdlib-{}-{}-{}.zip",
        base_url,
